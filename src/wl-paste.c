...
const struct zwlr_data_control_v1_listener data_control_listener = {
...
#ifdef HAVE_WLR_DATA_CONTROL
        zwlr_data_control_v1_add_listener(
            data_control,
            &data_control_listener,
            NULL
        );
#endif
    } else {
